...
let mobileMainCards = ` <div class="row g-0 d-flex justify-content-between align-items-center p-4">
											<div class="col-4">
...
//Function to play songs on player
let playSong = (event) => {
